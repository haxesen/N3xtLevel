        ...
        <div class="flex flex-col md:flex-row items-center gap-16 reveal">
            ...
            <div class="w-full md:w-1/2">
                <div class="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl group">
                    ...
                    <img src="/drone_shot.webp" alt="Professional Drone Photography" class="w-full h-auto object-cover transform group-hover:scale-105 transition-transform duration-700">
                    <!-- Overlay Text -->

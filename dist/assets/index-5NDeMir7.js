...
`;document.getElementById("hero-container").innerHTML=c;document.getElementById("services-container").innerHTML=d;document.getElementById("premium-content-container").innerHTML=u;document.getElementById("about-me-container").innerHTML=m;document.getElementById("portfolio-container").innerHTML=h;document.getElementById("contact-container").innerHTML=p;document.getElementById("footer-container").innerHTML=x;const v=()=>{const a=document.querySelectorAll(".reveal"),o=()=>{const i=window.innerHeight,l=100;a.forEach(n=>{n.getBoundingClientRect().top<i-l&&n.classList.add("active")})};a.length>0&&(window.addEventListener("scroll",o),o());const s=document.getElementById("contactForm"),r=document.getElementById("successMessage"),e=document.getElementById("formContent");s&&s.addEventListener("submit",i=>{i.preventDefault(),e.style.opacity="0",e.style.transition="opacity 0.5s ease",setTimeout(()=>{e.classList.add("hidden"),r.classList.remove("hidden"),r.classList.add("animate-fade-in")},500)});const t=document.getElementById("year");t&&(t.textContent=new Date().getFullYear())};document.addEventListener("click",a=>{const o=a.target.closest("[data-modal-open]");if(o){const s=o.getAttribute("data-modal-open"),r=document.getElementById(s);r&&(r.classList.add("active"),document.body.style.overflow="hidden")}if(a.target.closest("[data-modal-close]")){const s=a.target.closest(".modal-backdrop");s&&(s.classList.remove("active"),document.body.style.overflow="")}a.target.classList.contains("modal-backdrop")&&(a.target.classList.remove("active"),document.body.style.overflow="")});window.addEventListener("keydown",a=>{a.key==="Escape"&&(document.querySelectorAll(".modal-backdrop").forEach(o=>{o.classList.remove("active")}),document.body.style.overflow="")});v();
